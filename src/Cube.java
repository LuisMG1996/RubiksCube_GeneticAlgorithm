...
public class Cube {
    ...
    public void clockwiseBackRotation(){
        String aux;
        String aux2;
        String aux3;
        String aux_1;
        ...
        String aux_3;
        //--------------
        back.clockwiseRotateMatrix();
        //rotation principal side

        aux = right.matrix[0][2];
        aux2 = right.matrix[1][2];
        aux3 = right.matrix[2][2];

        //Top
        aux_1 = top.matrix[0][0];
        aux_2 = top.matrix[0][1];
        aux_3 = top.matrix[0][2];

        top.matrix[0][0] = aux;
        top.matrix[0][1] = aux2;
        top.matrix[0][2] = aux3;//listo

        aux = left.matrix[0][0];
        aux2 = left.matrix[1][0];
        aux3 = left.matrix[2][0];

        left.matrix[0][0] = aux_1;
        left.matrix[1][0] = aux_2;
        left.matrix[2][0] = aux_3;
